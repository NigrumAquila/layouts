...
<section class="contacts">
	<div class="map-block">
		<iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ab56fde3b455833282fb6eb7519c2e2e781dcce042de75a40a79fa5cd6c4d25bb&amp;source=constructor" width="100%" height="290" frameborder="0"></iframe>
				<div class="container">
					<div class="section-header-contacts">
						<h1>Контакты</h1>
						<p>Главная  >  О компании  >  Контакты</p>
					</div>
				</div>
	</div>
	<div class="container">	
			...
			<div class="col-md-7 col-sm-12">
				<div class="contact-form-block">
					...
					<form action="mailer/smart.php" method="post">
						<input type="text" placeholder="Ваше имя" name="user_name" required><br>
						<input class="demi-size-left" type="text" placeholder="Ваш e-mail" name="user_email" required>
						<input class="demi-size-right phone" type="text" placeholder="Ваш телефон" name="user_phone" required><br>
						<img src="src/img/contact/captcha.png" alt="Captcha">
						<input class="size-right" type="text" placeholder="Код с картинки" required><br>
						<input type="text" placeholder="Тема сообщения" name="user_subject" required><br>
						<textarea name="user_message" id="" cols="30" rows="7" placeholder="Введите ваше сообщение" required></textarea>
						<button class="basket-btn button-green popup-thanks" type="submit">Отправить сообщение</button>	
					</form>
				</div>
			</div>
			<div class="col-md-5 col-sm-12">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
				  	  <div class="adress-block">
				  		<img class="wow fadeIn" data-wow-delay="0.1s" src="src/img/contact/location.png" alt="">
				  		<p>Саранск,<br> ул. Севастопольская,<br>56/2-195</p> 
				  	</div>
				  </div>
				  <div class="col-md-6  col-sm-6  col-xs-12">
				  	<div class="adress-block ">
				  		<img class="wow fadeIn" data-wow-delay="0.4s" src="src/img/contact/phone.png" alt="">
				  		<p><span>+7 (8342) 312-717</span></p><br/>
				  			<a href="">Перезвоните мне</a>
				  	</div>
				  </div>
				  	<div class="col-md-6 col-sm-6 col-xs-12">
				  	<div class="adress-block ">
				  		<img class="wow fadeIn" data-wow-delay="0.7s" src="src/img/contact/mail.png" alt="">
				  		<p>info@havroshka.ru<br><a href="mailto:admin@mail.ru">Написать нам</a></p>
				  	</div>
				  </div>
				  <div class="col-md-6  col-sm-6  col-xs-12">
				  	<div class="adress-block">
				  		<img class="wow fadeIn" data-wow-delay="1s" src="src/img/contact/clock.png" alt="">
